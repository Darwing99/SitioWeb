...
$("#productos").on('submit', function(e){
    ...
    $.ajax({
        ...
        processData:false,
        beforeSend: function(){
            $('#guardar_producto').attr("disabled","disabled");
        ...
        success: function(msg){
            ...
            $("#guardar_producto").removeAttr("disabled");
        }
    });
});
...
$(document).ready(function() {
    ...
    var idioma=
       ...
       tablaProductos = $('#categoria_producto').DataTable({
        "paging": true,
        "lengthChange": true,
        "searching": true,
        "ordering": true,
...
$(document).ready(function(){
    var parametros={"action":"ajax"};
        ...
        $("#guardar").click(function(){
             ...
             if (cliente>0)
            {
               VentanaCentrada('../pdf/documentos/orden.php?cliente='+cliente);
            } else {
