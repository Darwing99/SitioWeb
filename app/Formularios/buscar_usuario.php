...
<div  class="margenes card-deck">
        ...
        <div class="modal-header text-center  yellow darken-2">
            ...
            <br>
            <?php
            $buscador=strtolower($_REQUEST['buscar']);
            if(empty($buscador)){
                header("location: Apertura_cierre.php");
            }
            ?>
            <div class="md-form">
                            <input type="email" id="buscar"name="buscar" class="form-control" placeholder="Buscar" value="<?php echo $buscador;?>">
            ...
            <div class="tabla_hide centrar_form">
                ...
                <table class="table table-bordered table-responsive-md table-striped text-center">
                       ...
                       <?php 
                         ...
                         $sql="SELECT A.id,A.nombre, A.usuario,
                                if(A.estado=0,'Inactivo','Activo') as Estad,B.tipo 
                                FROM rusuario AS A INNER JOIN rtipouser AS B where A._idtipo=B.idtipo 
                                and (A.id like'%$buscador%' or A.nombre like'%$buscador%' or A.usuario like '%$buscador%')";
