...
<div class="pt-5">    
        ...
        <div class="modal-header text-rigth  white darken-2">
                <h4 class="modal-title black-text w-50 font-weight-bold py-0">Lista de Proveedores</h4>
                <a id="ver"type="button" href="proveedores" class="btn btn-elegant"><i class="far fa-plus-square"></i> Nuevo</a>
            </div>
            <br>
...
<div class="modal fade modal-responsive" id="DeleteModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
        ...
        <div class="modal-dialog" role="document">
            ...
            <div class="modal-header text-center">
                <h4 class="modal-title w-100 font-weight-bold">Eliminar Proveedor?</h4>
            ...
            <div class="modal-body mx-3">
                ...
                <input type="text" id="idProveedor" class="form-control " readonly>
            ...
            <div class="modal-footer d-flex justify-content-center">
                <button type="submit" class="borrar_proveedor btn btn-elegant">Eliminar</button>
            </div>
            </div>
        </div>
        </form>
