    ...
    <div class="pt-5 card-deck">
          ...
          <div  class="col-sm-12 card mb-4">
            ...
            <div class="modal-header text-rigth  white darken-2">
                    ...
                    <!--Section: Content-->
                    <section type="button" class="pt-4 text-center">
                    ...
                    <!--Grid column-->
                    <div class="col-lg-2 col-md-12 mb-24">
                        ...
                        <div class="view overlay">
                            <img class="card-img-top" src="https://mdbootstrap.com/img/Photos/Horizontal/E-commerce/Products/shoes%20(6).jpg"
                            alt="Card image cap">
                            <a href="#!">
                        ...
                        <div class="card-body">
                            ...
                            <button type="button" class="btn btn-outline-black btn-rounded btn-sm px-3 waves-effect"><i class="fas fa-check-double"></i></button>
