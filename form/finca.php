...
<div  class="col-sm-12 card-body card-body-cascade text-center">
    ...
    <div class="card-body contact text-center h-100  black dark-text  view zoom overlay z-depth-2 rounded">

      <h3 class="titulo my-4 pb-2">Nuestro Café</h3>
      <div class="view overlay">
        <img src="../Media/img/cafe_la_ruta.jpg" class="img-fluid" alt="placeholder">
        ...
        <div class="col-lg-8">
          ...
          <div id="nuestro_cafe" class="card-body form">
