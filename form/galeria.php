...
<body>
    ...
    <main>
        ...
        <h2 class="titulo text-gray h1-responsive font-weight-bold text-center my-5">Imágenes de nuestro café diseñadas y 
        ...
        <div class="row ml-auto">
            <div class="gallery-block compact-gallery col-md-12 ">
